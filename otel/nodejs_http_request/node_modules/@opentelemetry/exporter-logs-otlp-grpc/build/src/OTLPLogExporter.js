...
class OTLPLogExporter extends otlp_grpc_exporter_base_1.OTLPGRPCExporterNodeBase {
    constructor(config = {}) {
        const signalSpecificMetadata = Object.assign(Object.assign({}, USER_AGENT), core_1.baggageUtils.parseKeyPairsIntoRecord((0, core_1.getEnv)().OTEL_EXPORTER_OTLP_LOGS_HEADERS));
        super(config, signalSpecificMetadata, 'LogsExportService', '/opentelemetry.proto.collector.logs.v1.LogsService/Export', otlp_transformer_1.ProtobufLogsSerializer);
    }
