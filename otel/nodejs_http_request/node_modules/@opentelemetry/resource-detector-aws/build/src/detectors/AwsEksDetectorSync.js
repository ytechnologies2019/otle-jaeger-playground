...
class AwsEksDetectorSync {
    ...
    async _getAttributes() {
        try {
            ...
            api_1.diag.debug('Process is not running on K8S', e);
            return {};
        }
    }
    /**
    ...
    async _getClusterName(cert) {
        ...
        try {
            ...
            api_1.diag.debug('Cannot get cluster name on EKS', e);
        }
        return '';
    }
    /**
    ...
    async _getK8sCredHeader() {
        try {
            ...
            api_1.diag.debug('Unable to read Kubernetes client token.', e);
        }
        return '';
    }
    /**
    ...
    async _getContainerId() {
        try {
            ...
            api_1.diag.debug(`AwsEksDetector failed to read container ID: ${e.message}`);
        }
        return undefined;
    }
    /**
